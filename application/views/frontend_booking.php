                  ...
                  <section id="Search" class="LB XXCN  P20">
                     ...
                     <div class="searchRow clearfix">
                        <div class="LB">
                           ...
                           <input  name="t_trip_fromlocation" class="XXinput searching" placeholder="Enter From" type="text" tabindex="1" required/>
                        </div>
                        <span class="switchButton" id="switchButton"></span>
                        <div class="searchRight NoPaddingRight">
                           <label class="inputLabel">To</label>
                           <input  name="t_trip_tolocation" class="XXinput searching" placeholder="Enter To" type="text" tabindex="2" required />
                        </div>
                     </div>
                    <div class="searchRow clearfix">
